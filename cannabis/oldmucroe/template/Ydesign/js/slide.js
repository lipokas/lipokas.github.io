...
this.each(function(){init(this);});};$.fn.jqFancyTransitions.defaults={width:770,height:220,strips:10,delay:7200,stripDelay:50,titleOpacity:0.7,titleSpeed:1000,position:'alternate',direction:'fountainAlternate',effect:'zipper',navigation:false,links:true};})(jQuery);