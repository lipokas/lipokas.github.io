<?
//links
define('link_home','Inicio');
define('link_announcements','Anuncios');
define('link_new_account','Registrarse');
define('link_log_out','Cerrar Sesi&oacute;n');
define('link_lost_password','Perdiste tu ID o Contrase&ntilde;a?');
...
define('link_location','Ubicaci&oacute;n');
define('link_account_settings','Opciones de Cuenta');

//buttons
define('button_log_in','Iniciar Sesi&oacute;n');
...
define('text_resetstats_t1','La cuenta esta conectada en el juego, desconecte y reintente');
