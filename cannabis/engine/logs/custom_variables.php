...
$secret_questions = array(
   1 => '¿Cuál es el nombre de su madre \'s de soltera?',
   2 => '¿Cuál era el nombre de tu primera escuela?',
   3 => '¿Quién es tu súper héroe favorito?',
   4 => '¿Cuál es el nombre de tu primera mascota?',
   5 => '¿Cuál era su lugar favorito para visitar cuando era niño?',
   6 => '¿Quién es tu personaje favorito de dibujos animados?',
   7 => '¿Cuál fue el primer videojuego que jugaste?',
   8 => '¿Cuál era el nombre de su primer maestro?',
   9 => '¿Cuál era tu programa favorito de televisión cuando era niño?',
   10 => '¿En qué ciudad nació su madre?',
